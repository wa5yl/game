	...
	if (this->timeElapsedR > 1.5) {
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::M)) {
			...
			case direction::right: 
				this->sprite.move(7.f, 0.f);
				this->hitbox.move(7.f, 0.f);
				this->startPoint = 40;
				this->endPoint = 44;
			...
			case direction::bottom:
				this->sprite.move(0.f, 7.f);
				this->hitbox.move(0.f, 7.f);
				this->startPoint = 55;
				this->endPoint = 59;
				this->unstopable_r = true;
